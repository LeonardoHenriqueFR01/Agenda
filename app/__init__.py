...
db = SQLAlchemy()  # Instância do SQLALCHEMY para interagir com o banco de dados
login_manager = LoginManager()  # Instância do LoginManager para gerenciar autenticação
...
def create_app():
    ...
    # Registra os blueprints (módulos que organizam as rotas e funcionalidades do app)
    from .routes import routes as auth_blueprint  # Importa o blueprint de autenticação
    app.register_blueprint(auth_blueprint)  # Registra o blueprint de autenticação no app
